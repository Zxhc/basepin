...
if (isset($_GET['ids']) && !empty($_GET['ids'])) {
    ...
    $dataCellStyle = [
        'alignment' => [
            'horizontal' => Alignment::HORIZONTAL_CENTER, // Center lahat horizontally
            'vertical' => Alignment::VERTICAL_CENTER    // Center lahat vertically
        ],
        'borders' => ['allBorders' => ['borderStyle' => Border::BORDER_THIN]]
    ];
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $sheet->getRowDimension($rowNum)->setRowHeight(20); // Nilagyan ng height ang bawat data row
